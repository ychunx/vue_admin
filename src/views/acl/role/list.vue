  ...
  <div>
    ...
    <div style="margin-bottom: 20px">
      <el-button
        type="primary"
        @click="addRole"
        v-show="$store.state.user.buttons.indexOf('btn.Role.add') != -1"
        >添加</el-button
      >
      <el-button
        type="danger"
        ...
        v-show="$store.state.user.buttons.indexOf('btn.Role.remove') != -1"
        >批量删除</el-button
      >
    </div>
      ...
      <el-table-column label="操作" width="300" align="center">
        <template slot-scope="{ row }">
          <el-button
            ...
            icon="el-icon-info"
            title="分配权限"
            v-show="$store.state.user.buttons.indexOf('btn.Role.assgin') != -1"
            @click="
          ...
          <el-button
            ...
            @click="row.edit = true"
            v-if="!row.edit"
            v-show="$store.state.user.buttons.indexOf('btn.Role.update') != -1"
          ></el-button>
