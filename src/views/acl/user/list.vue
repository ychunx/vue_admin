  ...
  <div class="app-container">
    ...
    <div style="margin-bottom: 20px">
      ...
      <el-button
        type="primary"
        @click="showAddUser"
        v-show="$store.state.user.buttons.indexOf('btn.User.add') != -1"
        >添 加</el-button
      >
      <el-button
        type="danger"
        ...
        v-show="$store.state.user.buttons.indexOf('btn.User.remove') != -1"
        >批量删除</el-button
      >
    </div>
        ...
        <template slot-scope="{ row }">
          ...
          >
            <el-button
              ...
              title="删除用户"
              v-show="
                $store.state.user.buttons.indexOf('btn.User.remove') != -1
              "
            ></el-button>
          </el-popconfirm>
        </template>
